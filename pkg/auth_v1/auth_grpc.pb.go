...
type AuthV1Client interface {
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*RefreshTokenResponse, error)
...
func (c *authV1Client) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*RefreshTokenResponse, error) {
...
type AuthV1Server interface {
	Login(context.Context, *LoginRequest) (*RefreshTokenResponse, error)
...
func (UnimplementedAuthV1Server) Login(context.Context, *LoginRequest) (*RefreshTokenResponse, error) {
